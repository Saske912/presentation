...
lineNumbers: false
info: |
  ## Infrastructure as Code для виртуальных машин
  Переход от ручного управления к автоматизации
drawings:
  persist: false
transition: slide-left
title: IaC для управления виртуальными машинами
mdc: true
---
